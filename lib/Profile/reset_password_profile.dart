...
import 'package:bookednise_app/Authentication/Registration/models/sign_up_model.dart';
import 'package:bookednise_app/Authentication/Registration/models/verify_email_model.dart';
import 'package:bookednise_app/Authentication/Registration/registration_1.dart';
import 'package:bookednise_app/Authentication/Registration/verify_email.dart';
import 'package:bookednise_app/Authentication/Registration/resend_verification.dart';
...
class ResetPasswordProfile extends StatefulWidget {
  final email;
  const ResetPasswordProfile({super.key, required this.email});
            ...
            if(data.message == "Successful, Password reset successfully.") {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => ResetPasswordProfile(email: widget.email,))
                );
