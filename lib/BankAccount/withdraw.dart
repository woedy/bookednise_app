...
Future<TransactionsModel> withdraw_money(String amount) async {
  var token = await getApiPref();
  var userId = await getUserIDPref();

  final response = await http.post(
    Uri.parse(
        hostName + "bank_account/" + userId.toString() + "/client-withdraw/"),
...
class Withdraw extends StatefulWidget {
  ...
  const Withdraw({super.key, required this.amount, required this.account_id});
...
class _WithdrawState extends State<Withdraw> {
  ...
  Future<TransactionsModel>? _futureWithdraw;
  ...
  Widget build(BuildContext context) {
    return (_futureWithdraw == null) ? buildColumn() : buildFutureBuilder();
  }
                      ...
                      InkWell(
                        onTap: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            _futureWithdraw = withdraw_money(amount!);
                          }
              ...
              WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                ...
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      // Show the dialog
                      return SuccessDialogBox(text: "Withdrawal Successful");
                    });
              });
            } else if (data.message == "Withdrawal failed") {
              WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
...
*/
                ...
                showDialog(
                  ...
                  context: context,
                  builder: (BuildContext context) {
                    return ErrorDialogBox(text: "Withdrawal failed");
                  },
                );
              });
            }
